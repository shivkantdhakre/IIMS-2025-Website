...
export const metadata: Metadata = {
  ...
  description: "International Conference on Innovations in Infrastructure Materials & Sustainability (IIMS-2025) organized by Department of Civil Engineering, MMMUT Gorakhpur",
  keywords: "IIMS-2025, civil engineering, infrastructure, materials, sustainability, conference, MMMUT",
};
