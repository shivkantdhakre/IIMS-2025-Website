...
export const metadata: Metadata = {
  title: 'IIMS-2025 | International Conference on Innovations in Infrastructure Materials & Sustainability',
  description: 'International Conference on Innovations in Infrastructural Materials & Sustainability (IIMS-2025) organized by Department of Civil Engineering, MMMUT Gorakhpur',
}
