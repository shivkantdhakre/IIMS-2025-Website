    ...
    <>
        ...
        <div className="abstract-section">
          ...
          <div className="abstract-container">
            <div className="abstract-card">
              <a href="https://forms.gle/fWmcezHi5Cr2nMGP9" target="_blank" rel="noopener noreferrer">
            ...
            <div className="abstract-card">
              <a href="https://docs.google.com/document/d/124jVcw_LIH8iSBz2gsMwA72fTLmiM5ar/edit?usp=sharing&ouid=105037033165098759051&rtpof=true&sd=true"
      ...
      <section>
        <div className="abstract-section">
          ...
          <ul>
            <li>
              <p className="description" style={{color: 'red'}}> <strong> Those who could not submit their abstract can also submit their full-length paper directly through the full-length paper submission link.</strong></p>
            </li>
          </ul>
          <div className="abstract-container">
            <div className="abstract-card">
              <a href="https://forms.gle/Dm9kkxqhqi6c5eiL6" target="_blank" rel="noopener noreferrer">
            ...
            <div className="abstract-card">
              <a href="https://docs.google.com/document/d/1J7q9cDCFhZaqD4UClJBO_5BFRYPHmViWPkhTzMWfIhY/edit?usp=sharing"
                target="_blank" rel="noopener noreferrer">
      ...
      <section>
        <div className="abstract-section">
          ...
          <ul>
            <li>
              <p className="description" style={{color: 'red'}}> <strong> Participants who have received acceptance may proceed with early bird registration. Delegates and accompanying persons can also register now. The rest of the participants, please wait for acceptance.</strong></p>
            </li>
          </ul>
          <div className="abstract-container">
            <div className="abstract-card">
              <a href="https://forms.gle/oSTYgWQ7NNUjn3xp9" target="_blank" rel="noopener noreferrer">
