...
export default function Publication() {
  useEffect(() => {
    ...
    function generateCards() {
      const container = document.querySelector('.Acommittee-cards-container')
      if (!container) return

      container.innerHTML = ''
      igsMembers.forEach(person => {
    ...
    <>
      ...
      <section className="abstract-info">
        <div className="about-section">
          ...
          <ul>
            <li>
              <p className="description" style={{color: 'red'}}><strong>Selected papers from the conference will be published by Springer
                as a proceedings book volume. Springer will conduct quality checks on the accepted papers and only papers
                that pass these checks will be published.</strong> </p>
            </li>
            <li>
              <p className="description" style={{color: 'red'}}><strong>Springer Nature does not charge any money for publication of
                Non-Open Access content. Abstracts/extended abstracts and short papers (less than 4 pages) are not
                considered for publication.</strong></p>
            </li>
          </ul>
          <div className="sponser">
            <Image src="https://cdn-images-1.medium.com/max/800/1*H7Pq3wD3b7gHKQQwXZlSRg.jpeg" alt="Springer Nature" width={200} height={100} />
          </div>
          <br />
          ...
          <div className="sponser">
            <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQICv2df1h6PQOCMsGeJ70JzcV7K_G14o6uIQ&s" alt="IGS" width={200} height={100} />
          </div>
        </div>
      </section>
