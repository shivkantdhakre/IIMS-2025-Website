...
export default function Committee() {
  useEffect(() => {
    ...
    function generateCards(people: any[], containerId: string) {
      ...
      people.forEach(person => {
        ...
        card.innerHTML = `
          ...
          <div class="img">
            <img src="${person.link}" alt="Profile">
          </div>
          <div class="card-text">
            <span>${person.name}</span>
            <p class="job">${person.title}</p>
            <p class="location">${person.location}</p>
            ${person.contact ? `<p class="job">${person.contact}</p>` : ''}
          </div>
        `
    ...
    generateCards(advisoryPeople, '.Acommittee-cards-container')
    generateCards(studentCoordinators, '.Acommittee-cards-container-2')
  }, [])
  ...
  return (
    <>
      ...
      <section className="committee">
        ...
        <div className="parent-card">
          <div className="card">
            ...
            <div className="img">
              <Image src="https://www.mmmut.ac.in/images/VC2.png" alt="Profile" width={80} height={80} />
            </div>
            <span>Prof. J. P. Saini</span>
            <p className="job">Hon&apos;ble Vice Chancellor</p>
            <p className="job job-small">Madan Mohan Malaviya University of Technology, Gorakhpur</p>
          </div>
        </div>
        ...
        <div className="parent-card">
          <div className="card">
            <div className="card-border-top"></div>
            <div className="img">
              <Image src="https://www.mmmut.ac.in/News_content/IMGFaculty29.jpg?637507973256744939" alt="Profile" width={80} height={80} />
            </div>
            <span>Prof. A.K. Mishra</span>
            <p className="job">Head</p>
            <p className="job" style={{fontSize: '10px'}}>Civil Engineering Department</p>
            <p className="job" style={{fontSize: '10px'}}>Madan Mohan Malaviya University of Technology, Gorakhpur</p>
          </div>
        </div>
        ...
        <div className="committee-row">
          <div className="parent-card">
            <div className="card">
              <div className="card-border-top"></div>
              <div className="img">
                <Image src="https://www.mmmut.ac.in/News_content/IMGFaculty153.jpg?63750505620939957" alt="Profile" width={80} height={80} />
              </div>
              <span>Dr. Vinay Kumar Singh</span>
              <p className="job">Assistant Professor</p>
              <p className="job" style={{fontSize: '10px'}}>Department of Civil Engineering</p>
              <p className="job" style={{fontSize: '10px'}}>Madan Mohan Malaviya University of Technology, Gorakhpur</p>
              <p className="job" style={{fontSize: '12px'}}>vksce@mmmut.ac.in</p>
              <p className="job" style={{fontSize: '12px'}}>+91 9235552358</p>
            </div>
          </div>
          ...
          <div className="parent-card">
            <div className="card">
              <div className="card-border-top"></div>
              <div className="img">
                <Image src="https://www.mmmut.ac.in/News_content/IMGFaculty246.jpg" alt="Profile" width={80} height={80} />
              </div>
              <span>Dr. Sneha Gupta</span>
              <p className="job">Assistant Professor</p>
              <p className="job" style={{fontSize: '10px'}}>Department of Civil Engineering</p>
              <p className="job" style={{fontSize: '10px'}}>Madan Mohan Malaviya University of Technology, Gorakhpur</p>
              <p className="job" style={{fontSize: '12px'}}>sgce@mmmut.ac.in</p>
              <p className="job" style={{fontSize: '12px'}}>+91 9235552354</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="Acommittee-cards-container"></div>
      ...
      <section className="committee-1">
        ...
        <div className="container-updated">
          ...
          <div className="committee-updated">
            ...
            <div className="card-container-updated">
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty29.jpg?637507973256744939" alt="Member" width={70} height={70} />
                <h3>Prof. A. K. Mishra</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty153.jpg?63750505620939957" alt="Member" width={70} height={70} />
                <h3>Dr. Vinay Kumar Singh</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty246.jpg" alt="Member" width={70} height={70} />
                <h3>Dr. Sneha Gupta</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty285.jpg?63752959284513953" alt="Member" width={70} height={70} />
          ...
          <div className="committee-updated">
            ...
            <div className="card-container-updated">
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty67.JPG?637533086151612222" alt="Member" width={70} height={70} />
                <h3>Prof. Shri Ram</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://www.sirmvit.edu/wp-content/uploads/2024/06/Pavan-Photo-175x175.jpg" alt="Member" width={70} height={70} />
                <h3>Dr. Pavan Kumar Kummamuru</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty280.jpg?63786875698220601" alt="Member" width={70} height={70} />
                <h3>Dr. Rohit Kumar</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty275.jpg" alt="Member" width={70} height={70} />
          ...
          <div className="committee-updated">
            ...
            <div className="card-container-updated">
              ...
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty410.JPG" alt="Member" width={70} height={70} />
                <h3>Dr. R. K. Shukla</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
          ...
          <div className="committee-updated">
            ...
            <div className="card-container-updated">
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty79.jpg" alt="Member" width={70} height={70} />
                <h3>Prof. Govind Pandey</h3>
                <p>MMMUT</p>
              </div>
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty73.jpg" alt="Member" width={70} height={70} />
          ...
          <div className="committee-updated">
            ...
            <div className="card-container-updated">
              ...
              <div className="card-updated">
                <Image src="https://mmmut.ac.in/News_content/IMGFaculty268.jpg?63750368675332120" alt="Member" width={70} height={70} />
      ...
      <section className="committee-1">
        ...
        <div className="Acommittee-cards-container-2"></div>
      </section>
